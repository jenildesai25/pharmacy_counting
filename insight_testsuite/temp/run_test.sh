...
time tail +2 ./input/itcont.txt | python ./src/mapper.py | sort | python ./src/reducer.py | sort -t $'\t' -k 3nr -k 1,1  | python -i ./src/saveOutput.py  -o./output/top_cost_drug.txt
echo "Done"
...
time tail +2 ./input/de_cc_data_head500.txt | python ./src/mapper.py | sort | python ./src/reducer.py | sort -t $'\t' -k 3nr -k 1,1  | python -i ./src/saveOutput.py -o ./output/top_cost_drug_head500.txt
echo "Done"
